...
from log_reg.algorithms import fista, ista, prox_sg
...
def main():
    ...
    parameter['stepsize_at_k'] = lambda k: 1/(parameter['prox_Lips'] + k**(0.55))
    ...
    print(error)
    plt.scatter( error.keys(), error.values())
    plt.xlabel('Methods')
    plt.ylabel('Ratio of inccorrect classified points')
    plt.legend()
    plt.show()
